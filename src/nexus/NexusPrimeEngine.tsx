...
export default function NexusPrimeEngine() {
  ...
  return (
    // 🛡️ Container changed to 'relative' with no 'overflow-hidden' to allow the Footer to exist naturally
    <div className="w-full min-h-screen relative flex flex-col bg-black overflow-y-auto overflow-x-hidden custom-scrollbar">
      ...
      {/* 🌊 TRANSMISSION STREAM */}
      <main className="relative flex-1 px-4 md:px-8 pt-20 z-10">
        
        {/* 🎬 DYNAMIC LOGO (Now absolutely positioned inside the main flow) */}
        <div className="absolute top-0 left-0 w-full h-[80vh] z-0 pointer-events-none flex items-center justify-center p-8 md:p-32 overflow-hidden">
          <video
            autoPlay
            loop
            muted
          ...
          {/* Fades to make the bottom of the video blend into the black page for the footer */}
          <div className="absolute inset-0 bg-gradient-to-b from-black/20 via-transparent to-black" />
          <div className="absolute inset-0 bg-[radial-gradient(circle_at_center,transparent_0%,black_90%)]" />
        </div>

        <div className="max-w-4xl mx-auto space-y-10 md:space-y-14 pb-48 relative z-10">
          {chatThread.length === 0 && (
      ...
      {/* 🏁 The "Real" Site Footer would go here in your Layout or at the bottom of this div */}
