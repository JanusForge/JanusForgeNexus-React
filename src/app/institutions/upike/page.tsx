      ...
      <div className="max-w-7xl mx-auto">
        <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-6 mb-12">
          <div>
            ...
            <h1 className="text-5xl font-black uppercase tracking-tighter italic text-[#FF671D]">UPIKE <span className="text-white">Elliott Node</span></h1>
          </div>
        ...
        <NodeCouncil 
          key={`UPIKE-${activeRole}`} // 🔑 This forces the reset
