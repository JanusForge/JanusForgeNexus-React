...
import { Zap, Loader2, Globe, ShieldCheck, Clock, ChevronRight, Share2, ArrowRight } from 'lucide-react';
...
export default function HomePage() {
  ...
  useEffect(() => {
    ...
    fetchForgeStatus();
    const syncInterval = setInterval(fetchForgeStatus, 300000); // Sync every 5 mins
  ...
  useEffect(() => {
    const timer = setInterval(() => {
      ...
      // Use server's nextReset or fallback to UTC Midnight
    ...
    <div className="min-h-screen bg-black text-white font-sans selection:bg-blue-500/30">
      ...
      <div className="max-w-7xl mx-auto px-4 py-16">
        <div className="grid lg:grid-cols-[1.2fr_0.8fr] gap-12 items-start">
          ...
          {/* 🛡️ THE FORGE CONVERSATION PANEL (RESTORED) */}
            ...
            <div className="flex flex-col md:flex-row border-b border-gray-800">
               <div className={`p-6 space-y-4 ${isShareOpen ? 'md:w-2/3 w-full' : 'w-full'}`}>
                 <textarea 
                   ...
                   className="w-full bg-gray-900/50 border border-gray-700 rounded-xl p-4 text-white min-h-[150px] outline-none focus:border-blue-500 transition-all resize-none"
                 />
               ...
               {isShareOpen && (
                 <div className="md:w-1/3 w-full p-4 border-l border-gray-800 bg-black/20 animate-in slide-in-from-right">
                  ...
                  <div className="flex gap-4">
                    ...
                    <div className="flex-1 space-y-1">
                      <div className="flex items-center gap-2">
                        ...
                        {msg.name === 'Architect' && <span className="text-[8px] bg-blue-500 px-2 py-0.5 rounded font-black text-white uppercase">Interjection</span>}
                      </div>
