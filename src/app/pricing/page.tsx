  ...
  const handleStripeCheckout = async (pkg: any) => {
    ...
    try {
      ...
      if (response.ok && data.url) {
        ...
        // FAIL: Throw the specific error message from the backend/Stripe
        throw new Error(data.error || 'The Nexus was unable to generate a checkout session.');
      }
    } catch (err: any) {
      console.error('Checkout error:', err);
      // 🛠️ REFINED ALERT: This will now show the actual API version error if it persists
